...
def calculate_demographic_data(print_data=True):
    ...
    country_high_earning = df[df['salary'] == '>50K']['native-country'].value_counts()
    perc_high_earn = (100 * country_high_earning / country_counts).dropna()
    highest_earning_country = perc_high_earn.idxmax()
    highest_earning_country_percentage = round(perc_high_earn.max(), 1)
